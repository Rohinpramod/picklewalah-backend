...
exports.updateMenuItem = async (req, res) => {
  try {
    ...
    const { name, price, category,quantity, isAvailable ,ingredients,description } = req.body;

    let updateFields = { name, price,quantity, category, isAvailable, ingredients,description};
